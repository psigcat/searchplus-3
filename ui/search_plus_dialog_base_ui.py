...
class Ui_searchPlusDockWidget(object):
    def setupUi(self, searchPlusDockWidget):
        ...
        searchPlusDockWidget.setFeatures(QtWidgets.QDockWidget.AllDockWidgetFeatures)
        ...
        self.searchPlusTabMain = QtWidgets.QTabWidget(self.contents)
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.searchPlusStreetsTab = QtWidgets.QWidget()
        self.searchPlusStreetsTab.setObjectName(_fromUtf8("searchPlusStreetsTab"))
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.searchPlusStreetsTab)
        self.verticalLayout_2.setObjectName(_fromUtf8("verticalLayout_2"))
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_2.setObjectName(_fromUtf8("horizontalLayout_2"))
        self.lblStreet = QtWidgets.QLabel(self.searchPlusStreetsTab)
        ...
        self.lblNumber = QtWidgets.QLabel(self.searchPlusStreetsTab)
        ...
        self.searchPlusToponimsTab = QtWidgets.QWidget()
        self.searchPlusToponimsTab.setObjectName(_fromUtf8("searchPlusToponimsTab"))
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.searchPlusToponimsTab)
        self.verticalLayout_3.setObjectName(_fromUtf8("verticalLayout_3"))
        self.lblTopo = QtWidgets.QLabel(self.searchPlusToponimsTab)
        ...
        self.searchPlusEquipmentsTab = QtWidgets.QWidget()
        self.searchPlusEquipmentsTab.setObjectName(_fromUtf8("searchPlusEquipmentsTab"))
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(self.searchPlusEquipmentsTab)
        self.verticalLayout_4.setObjectName(_fromUtf8("verticalLayout_4"))
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_4.setObjectName(_fromUtf8("horizontalLayout_4"))
        self.lblType = QtWidgets.QLabel(self.searchPlusEquipmentsTab)
        ...
        self.lblEquipment = QtWidgets.QLabel(self.searchPlusEquipmentsTab)
        ...
        self.searchPlusCadastreTab = QtWidgets.QWidget()
        self.searchPlusCadastreTab.setObjectName(_fromUtf8("searchPlusCadastreTab"))
        self.verticalLayout_5 = QtWidgets.QVBoxLayout(self.searchPlusCadastreTab)
        self.verticalLayout_5.setObjectName(_fromUtf8("verticalLayout_5"))
        self.lblCadastre = QtWidgets.QLabel(self.searchPlusCadastreTab)
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.searchPlusPlotsTab = QtWidgets.QWidget()
        self.searchPlusPlotsTab.setObjectName(_fromUtf8("searchPlusPlotsTab"))
        self.verticalLayout_7 = QtWidgets.QVBoxLayout(self.searchPlusPlotsTab)
        self.verticalLayout_7.setObjectName(_fromUtf8("verticalLayout_7"))
        self.horizontalLayout_8 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_8.setObjectName(_fromUtf8("horizontalLayout_8"))
        self.lblUrbanCore = QtWidgets.QLabel(self.searchPlusPlotsTab)
        ...
        self.lblPlot = QtWidgets.QLabel(self.searchPlusPlotsTab)
        ...
        self.searchPlusUTMTab = QtWidgets.QWidget()
        self.searchPlusUTMTab.setObjectName(_fromUtf8("searchPlusUTMTab"))
        self.verticalLayout_6 = QtWidgets.QVBoxLayout(self.searchPlusUTMTab)
        self.verticalLayout_6.setObjectName(_fromUtf8("verticalLayout_6"))
        self.lblUTM = QtWidgets.QLabel(self.searchPlusUTMTab)
